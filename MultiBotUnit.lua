MultiBot.newUnit = function(pParent, pName, pClass, pX, pY, pSize)
	...
	frame.doDisable = function()
		frame.parent.doDisable(frame.name, frame.class)
	end
	
	frame.doEnable = function()
		frame.parent.doEnable(frame.name, frame.class)
	end
